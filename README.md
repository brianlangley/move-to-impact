...
* Als marketing manager wil ik een product landingspagina voor ons platform/online product zodat nieuwe potentiële klanten kunnen bekijken waar het platform over gaat
...
* Als consultant wil ik dat er genoeg content op de pagina aanwezig is zodat potentiële klanten begrijpen hoeveel kennis allemaal op het platform aanwezig is
...
| ------ | ------ | ------ |------ |
| Hero landing video + Animation effects | Batuhan Yumak | ✅ | [Branch](https://bitlab.bit-academy.nl/brianlangley/move-to-impact/-/tree/Batuhan) |
| Video + Powerpoint + Loading animation + Documentation | Brian Langley | ✅ |[Branch](https://bitlab.bit-academy.nl/brianlangley/move-to-impact/-/tree/Brian) |
| Carrousel + navbar  | Christian de Winter | ✅ |[Branch](https://bitlab.bit-academy.nl/brianlangley/move-to-impact/-/tree/Christian)|
| Page layout + Footer and contact | Emanuel Eguizabal Ascencio  | ✅ |[Branch](https://bitlab.bit-academy.nl/brianlangley/move-to-impact/-/tree/Emanuel)|
| Demo section + Mobile Friendly | Nick Prooij | ✅ |[Branch](https://bitlab.bit-academy.nl/brianlangley/move-to-impact/-/tree/Nick)|
